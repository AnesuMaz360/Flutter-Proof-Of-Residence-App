...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getRecords(
    ...
    records.add({
      ...
      'ward': ward,
      'address': address,
      'municipalityAccNo': municipalityAccNo,
      'official': official
    });
    return;
  }
  ...
  Future<void> _createProofOfRes(
    ...
    final PdfPageTemplateElement custom =
        PdfPageTemplateElement(Offset(200, 0) & page2.getClientSize(), page2);
    ...
    custom.graphics.drawString(
        ...
        bounds: Rect.fromLTWH(-150, 300, 400, 400));
